...
def test_nexus_function_metadata(
    idac_cmd: list[str],
...
def test_nexus_disasm(
    ...
    payload = run_nexus_json(idac_cmd, idac_env, copy_database(tiny_database), "disasm", "main")
...
def test_nexus_strings_scan_range_query(
    idac_cmd: list[str],
    idac_env: dict[str, str],
    copy_database,
    tiny_database: Path,
...
def test_nexus_imports(
    idac_cmd: list[str],
    idac_env: dict[str, str],
    copy_database,
    tiny_database: Path,
) -> None:
    payload = run_nexus_json(idac_cmd, idac_env, copy_database(tiny_database), "imports")
...
def test_nexus_proto_show(
    idac_cmd: list[str],
    idac_env: dict[str, str],
    copy_database,
    tiny_database: Path,
) -> None:
    payload = run_nexus_json(idac_cmd, idac_env, copy_database(tiny_database), "function", "prototype", "show", "add")
...
def test_nexus_function_metadata_reports_missing_symbol(
    idac_cmd: list[str],
    idac_env: dict[str, str],
    copy_database,
    tiny_database: Path,
...
def test_nexus_disasm_reports_missing_symbol(
    idac_cmd: list[str],
    idac_env: dict[str, str],
    copy_database,
    tiny_database: Path,
...
def test_nexus_xrefs_reports_missing_symbol(
    idac_cmd: list[str],
    idac_env: dict[str, str],
    copy_database,
    tiny_database: Path,
