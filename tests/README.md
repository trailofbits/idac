...
- `test_idalib_*.py`: fixture-backed `idalib` integration coverage
...
- Tests open copied databases under a temporary runtime directory so each case can mutate safely.
