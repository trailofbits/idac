...
def test_nexus_ctree_dump(idac_cmd: list[str], idac_env: dict[str, str], copy_database, tiny_database: Path) -> None:
    database = copy_database(tiny_database)

    result = run_nexus_json(idac_cmd, idac_env, database, "ctree", "main")
