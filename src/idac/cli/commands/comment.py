...
def register(
    ...
    child = add_standard_command(
        ...
        comment_subparsers,
        "show",
        help_text="Show a comment",
        run=run_bound_operation,
    )
    bind_operation(child, OperationBinding("comment_get", params_builder=_comment_lookup_params))
    ...
    child = add_standard_command(
        ...
        comment_subparsers,
        "set",
        help_text="Set a comment",
        run=run_bound_operation,
        default_format="json",
    )
    bind_operation(child, OperationBinding("comment_set", params_builder=_comment_change_params))
    child.add_argument("identifier", help="Address or symbol")
    ...
    bind_operation(child, OperationBinding("comment_delete", params_builder=_comment_lookup_params))
    child.add_argument("identifier", help="Address or symbol")
    _add_comment_target_options(child)
