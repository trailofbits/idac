...
run_idat "$BIN_DIR/tiny" "$IDB_DIR/tiny.i64" "$IDB_DIR/tiny.log"
run_idat "$BIN_DIR/tiny.stripped" "$IDB_DIR/tiny_stripped.i64" "$IDB_DIR/tiny_stripped.log"

echo "generated: $IDB_DIR/tiny.i64"
echo "generated: $IDB_DIR/tiny_stripped.i64"
